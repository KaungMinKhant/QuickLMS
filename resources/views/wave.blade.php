...
$data = [
    ...
    'backend_result_url' => "https://m.me/myeo.hub",

    // string - mendatory frontend url for Payment Service
    'frontend_result_url' => "https://m.me/myeo.hub?ref=authorized",
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card" style="width: 100%;">
                <img class="card-img-top" src="{{asset('images/lann-sa.png')}}" alt="Card image cap">
                <div class="card-body">
